...
-- Last modification date: 2024-06-14 21:39:21.394

-- tables
-- Table: Archer
CREATE TABLE Archer
(
    Person_PESEL text NOT NULL
        CONSTRAINT Archer_pk PRIMARY KEY,
    Rank         text NOT NULL,
    LeaveReason  text,
...
(
    ID            integer NOT NULL
        CONSTRAINT ArrowSet_pk PRIMARY KEY,
    Person_PESEL  text    NOT NULL,
    MinQuantity   integer NOT NULL,
    ArrowQuantity integer NOT NULL,
    State         text    NOT NULL,
    ArrowLength   double  NOT NULL,
    CONSTRAINT ArrowSet_Person FOREIGN KEY (Person_PESEL)
        REFERENCES Person (PESEL)
);
...
(
    ...
    ArrowSet_ID integer NOT NULL
        CONSTRAINT ArrowSetIndoor_pk PRIMARY KEY,
...
(
    ...
    Diameter    double  NOT NULL,
    ArrowSet_ID integer NOT NULL
        CONSTRAINT ArrowSetOutdoor_pk PRIMARY KEY,
...
(
    Material    text    NOT NULL,
    ArrowSet_ID integer NOT NULL
        CONSTRAINT ArrowSetTraining_pk PRIMARY KEY,
...
(
    Name             text     NOT NULL
        CONSTRAINT Competition_pk PRIMARY KEY,
    Description      text,
    Place            text     NOT NULL,
...
(
    Bow_NickName text   NOT NULL
        CONSTRAINT CompoundBow_pk PRIMARY KEY,
...
(
    Bow_NickName          text    NOT NULL
        CONSTRAINT OlympicBow_pk PRIMARY KEY,
...
(
    Person_PESEL      text NOT NULL
        CONSTRAINT President_pk PRIMARY KEY,
...
(
    ...
    CONSTRAINT UniversalSet_pk PRIMARY KEY (ArrowSetIndoor_ArrowSet_ID, ArrowSetOutdoor_ArrowSet_ID,
                                            ArrowSetTraining_ArrowSet_ID),
